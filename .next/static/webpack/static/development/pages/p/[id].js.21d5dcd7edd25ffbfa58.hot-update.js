...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(NavSideBar, [{
    ...
    value: function render() {
      ...
      var tmp = sculptures.map(function (s, i) {
        return __jsx("li", {
          key: i,
          __source: {
      ...
      for (var i = 0; i < 23; i++) {
        tmp2.push(i % 2 == 0 ? sculptures[0] : sculptures[1]);
      }

      tmp.concat(tmp).concat(tmp).concat(tmp).concat(tmp).concat(tmp).concat(tmp).concat(tmp).concat(tmp).concat(tmp).concat(tmp);
...
//# sourceMappingURL=[id].js.21d5dcd7edd25ffbfa58.hot-update.js.map