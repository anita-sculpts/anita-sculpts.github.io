...
var SculpturePage = function SculpturePage() {
  ...
  if (currentSculpture.price !== null) {
    priceText = " | ".concat(__jsx("b", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 43
      },
      __self: this
    }, "Price:"), " ").concat(currentSculpture.price.toFixed(2).toLocaleString());
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "Dimensions:"), " ", currentSculpture.dimensions, priceText), forSaleElement))));
};
...
//# sourceMappingURL=[id].js.d5267f89d9d4d4f0bf96.hot-update.js.map